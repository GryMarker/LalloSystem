...
<div class="sidebar">
    ...
    <div class="sidebar-content">
        <ul class="lists">
            ...
            <li class="list"><a href="{{ route('staff.follow-up-checkups') }}" class="nav-link"><i class="bx bx-refresh icon"></i><span class="link">Follow-Up Checkups</span></a></li>
            <li class="list"><a href="{{ route('staff.health-monitoring') }}" class="nav-link"><i class="bx bx-heart icon"></i><span class="link">Health Monitoring</span></a></li>
        ...
        <div class="bottom-content">
            <ul class="lists">
                ...
                <li class="list"><a href="#" class="nav-link"><i class="bx bx-log-out icon"></i><span class="link">Logout</span></a></li>
            </ul>
        </div>
    </div>
</div>